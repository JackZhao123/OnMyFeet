...
@IBDesignable class GradientSlider: UIControl {
    ...
    var endBlock:(GradientSlider,CGFloat, CGPoint)->() = {slider,newValue,newLocation in }
    ...
    override func endTracking(_ touch: UITouch?, with event: UIEvent?) {
        var theValue: CGFloat?
        var theLocation: CGPoint?
        ...
        endBlock(self, theValue!, theLocation!)
    ...
    fileprivate func updateTrackColors() {
        ...
        _trackLayer.locations = theLoc as [NSNumber]?
    }
}
